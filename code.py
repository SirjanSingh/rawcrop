...
input_folder = r"E:\Astrophotography\25_feb_camera\mily\wait"  # Folder with RAW images
output_folder = r"E:\Astrophotography\25_feb_camera\mily\two"  # Folder for cropped output
...
for filename in os.listdir(input_folder):
    if filename.lower().endswith(('.arw', '.dng', '.nef', '.cr2')):  # Add more formats if needed
        ...
        with rawpy.imread(raw_path) as raw:
            ...
            cropped_image = raw_image[:height-500, :]
